                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">DAFTAR PERANGKAT</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class=" display nowrap" style="width:100%">
                                <table class="table table-responsive text-nowrap  table-striped table-bordered" id="table_pk">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>NO INVENTARIS</th>
                            ...
                            <div class="modal fade" id="pk-model" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="pkModel"></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="pkForm" name="pkForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label">SERIAL NO</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="SERIAL_NO" name="SERIAL_NO" placeholder="Enter Serial No" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">SPESIFIKASI</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="SPESIFIKASI" name="SPESIFIKASI" placeholder="Enter Spesifikasi" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">TANGGAL PENERIMAAN</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="TANGGAL_PENERIMAAN" name="TANGGAL_PENERIMAAN" placeholder="Enter Tanggal Penerimaan" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label">PENGADAAN VIA</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="PENGADAAN_VIA" name="PENGADAAN_VIA" placeholder="Enter Pengadaan Via" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">MERK</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="MERK" name="MERK" placeholder="Enter Merk" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">SERI</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="SERI" name="SERI" placeholder="Enter Seri" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                ...
                function editFunc(id) {
                    $.ajax({
                        ...
                        , success: function(res) {
                            $('#pkModel').html("Edit Form Perangkat");
                            $('#pk-model').modal('show');
                            $('#id').val(res.id);
                            $('#NO_INVENTARIS').val(res.NO_INVENTARIS);
                            $('#SERIAL_NO').val(res.SERIAL_NO);
                            $('#SPESIFIKASI').val(res.SPESIFIKASI);
                            $('#TANGGAL_PENERIMAAN').val(res.TANGGAL_PENERIMAAN);
                            $('#PENGADAAN_VIA').val(res.PENGADAAN_VIA);
                            $('#MERK').val(res.MERK);
                            $('#SERI').val(res.SERI);
                ...
                function deleteFunc(id) {
                    if (confirm("Delete Record?") == true) {
                        ...
                        $.ajax({
                            ...
                            , dataType: 'json'
                            , success: function(res) {
                                var oTable = $('#table_pk').dataTable();
                                oTable.fnDraw(false);
                            }
                        });
                    }
                }
                $('#pkForm').submit(function(e) {
                    e.preventDefault();
