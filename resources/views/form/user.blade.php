...
<title>Halaman Form Penyerahan User</title>
<body>

    <div class="container">
        <h2 class="alert alert-danger text-center mt-3">FORM PENYERAHAN USER</h2>

        <form id='PENYERAHAN_USER'>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="NO_PENYERAHAN_USER">NO PENYERAHAN USER</label>
                        <input type="text" name="NO_PENYERAHAN_USER" class="form-control" placeholder="Masukkan No Penyerahan User Anda" id="NO_PENYERAHAN_USER">
                    </div>
                    <br>
                </div>
        ...
        <br>
        <div class="ⓒ copyright">
            <font style="color:#7e7474">2022 &copy;Layanan TI. RR</font>
        </div>

        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script type="text/javascript">
            $('#PENYERAHAN_USER').on('click', '#button-save', function(e) {
                e.preventDefault();
                $.ajax({
                    headers: {
                    ...
                    , method: 'POST'
                    , url: 'http://127.0.0.1:8000/Halaman/user'
                    , data: $('#PENYERAHAN_USER').serialize(),
