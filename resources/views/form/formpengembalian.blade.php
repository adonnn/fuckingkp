...
<body>
    ...
    <div class="container">
        <h2 class="alert alert-danger text-center mt-3">FORM PENGEMBALIAN</h2>

        <form id='PENGEMBALIAN'>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="NO_PENGEMBALIAN">NO PENGEMBALIAN</label>
                        <input type="text" name="NO_PENGEMBALIAN" class="form-control" placeholder="Masukkan No Pengembalian Anda" id="NO_PENGEMBALIAN">
                    </div>
                    <br>
                </div>
        ...
        <br>
        <div class="ⓒ copyright">
            <font style="color:#7e7474">2022 &copy;Layanan TI. AMA</font>
        </div>

        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script type="text/javascript">
            $('#PENGEMBALIAN').on('click', '#button-save', function(e) {
                e.preventDefault();
                $.ajax({
                    headers: {
                    ...
                    , method: 'POST'
                    , url: 'http://127.0.0.1:8000/Halaman/formpengembalian'
