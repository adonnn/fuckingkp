...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">DATATABLE BERITA ACARA SERAH TERIMA</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class=" display nowrap" style="width:100%">
                                <table class="table table-responsive text-nowrap  table-striped table-bordered" id="coba">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>NO BAST</th>
                            ...
                            <div class="modal fade" id="coba-modal" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="CobaModal"></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="CobaForm" name="CobaForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id" id="id">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-10 control-label">NO BAST</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="NO_BAST" name="NO_BAST" placeholder="Enter NO BAST" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
    ...
    <script>
        ...
        function add() {
            $('#CobaForm').trigger("reset");
            $('#CobaModal').html("Add Coba");
            $('#coba-modal').modal('show');
            $('#id').val('');
        }
        ...
        function editFunc(id) {
            $.ajax({
                ...
                , success: function(res) {
                    $('#CobaModal').html("Edit Form BAST");
                    $('#coba-modal').modal('show');
                    $('#id').val(res.id);
                    $('#NO_BAST').val(res.NO_BAST);
        ...
        function deleteFunc(id) {
            if (confirm("Delete Record?") == true) {
                ...
                $.ajax({
                    ...
                    , dataType: 'json'
                    , success: function(res) {
                        var oTable = $('#coba').dataTable();
                        oTable.fnDraw(false);
                    }
                });
            }
        }
        $('#CobaForm').submit(function(e) {
            e.preventDefault();
