                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">DAFTAR UNIT KERJA</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class=" display nowrap" style="width:100%">
                                <table class="table table-responsive text-nowrap  table-striped table-bordered" id="uk">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>ID UNIT KERJA</th>
                            ...
                            <div class="modal fade" id="uk-modal" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="ukModal"></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="ukForm" name="ukForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="DESKRIPSI" name="DESKRIPSI" placeholder="Enter Deskripsi" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
        ...
        function deleteFunc(id) {
            if (confirm("Delete Record?") == true) {
                ...
                $.ajax({
                    ...
                    , dataType: 'json'
                    , success: function(res) {
                        var oTable = $('#uk').dataTable();
                        oTable.fnDraw(false);
                    }
                });
            }
        }
        $('#ukForm').submit(function(e) {
            e.preventDefault();
