...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">DAFTAR MASTER TINDAKAN</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class=" display nowrap" style="width:100%">
                                <table class="table table-responsive text-nowrap  table-striped table-bordered" id="mt">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>ID TINDAKAN</th>
                            ...
                            <div class="modal fade" id="mt-modal" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="mtModal"></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="mtForm" name="mtForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id" id="id">
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label">ID TINDAKAN</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="ID_TINDAKAN" name="ID_TINDAKAN" placeholder="Enter Id Tindakan" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">DESKRIPSI TINDAKAN</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="DESKRIPSI_TINDAKAN" name="DESKRIPSI_TINDAKAN" placeholder="Enter Deskripsi Tindakan" required="">
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //LOAD DATATABLE
            //script untmt memanggil data json dari server dan menampilkannya berupa datatable
        ...
        function editFunc(id) {
            $.ajax({
                ...
                , success: function(res) {
                    $('#mtModal').html("Edit Form Master Tindakan");
                    $('#mt-modal').modal('show');
                    $('#id').val(res.id);
                    $('#ID_TINDAKAN').val(res.ID_TINDAKAN);
                    $('#DESKRIPSI_TINDAKAN').val(res.DESKRIPSI_TINDAKAN);
                }
            });
        }
