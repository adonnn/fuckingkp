    ...
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">DATATABLE PENGEMBALIAN</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class=" display nowrap" style="width:100%">
                                <table class="table table-responsive text-nowrap table-striped table-bordered" id="kembali">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                            ...
                            <div class="modal fade" id="kembali-modal" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="kembaliModal"></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="kembaliForm" name="kembaliForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id" id="id">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-10 control-label">NO PENGEMBALIAN</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="NO_PENGEMBALIAN" name="NO_PENGEMBALIAN" placeholder="Enter NO PENGEMBALIAN" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
        ...
        <script>
            ...
            function add() {
                ...
                $('#kembaliModal').html("Add kembali");
                $('#kembali-modal').modal('show');
                $('#id').val('');
            }
            ...
            function editFunc(id) {
                $.ajax({
                    type: "POST"
                    , url: "{{ url('edit-kembali') }}"
                    , data: {
                        id: id
                    }
                    , dataType: 'json'
                    , success: function(res) {
                        $('#kembaliModal').html("Edit Form Pengembalian");
                        $('#kembali-modal').modal('show');
                        $('#id').val(res.id);
                        $('#NO_PENGEMBALIAN').val(res.NO_PENGEMBALIAN);
            ...
            function deleteFunc(id) {
                if (confirm("Delete Record?") == true) {
                    ...
                    $.ajax({
                        type: "POST"
                        , url: "{{ url('delete-kembali') }}"
                        , data: {
                            id: id
                        }
                        , dataType: 'json'
                        , success: function(res) {
                            var oTable = $('#kembali').dataTable();
                            oTable.fnDraw(false);
                        }
                    });
                }
            ...
            $('#kembaliForm').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST'
                    , url: "{{ url('store-kembali')}}"
                    , data: formData
                    , cache: false
                    , contentType: false
                    , processData: false
                    , success: (data) => {
                        $("#kembali-modal").modal('hide');
                        var oTable = $('#kembali').dataTable();
                        oTable.fnDraw(false);
